...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': [
        ...
        # Allow a single global token (read from GLOBAL_API_TOKEN env var)
        # This provides a simple machine-token for frontend/CI to use.
        'backend.global_auth.GlobalAPITokenAuthentication',
    ],
